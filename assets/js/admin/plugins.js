$().ready(function() {
    var post_url = Plexis.url + "/admin_ajax/plugins";
    
    /**
     * DataTables
     */
    var table = $('#plugins-table').dataTable({
        "bServerSide": true,
        "bSortClasses": false,
    ...
    // ============================================
    // Install
    $("#plugins-table").on('click', '.install', function(){
        var name = this.name;
    ...
    // ============================================
    // Uninstall
    $("#plugins-table").on('click', '.un-install', function(){
        var name = this.name;
        
        // Check for plexis as its un recomended to uninstall
        if(name == 'Plexis')
        {
            $.msgbox('It is not recomended to uninstall the Plexis plugin. Are you sure you want to proceed?', {type : 'confirm'}, function(result) {
                if (result == "Accept")
                {
