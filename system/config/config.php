...
| ---------------------------------------------------------------
|
| 'enable_remote_debugger' - Set to true to enable debugging via 
|   the remote debugger Gui
| 
*/

$config['enable_remote_debugger'] = true;
$config['remote_debugger_username'] = 'admin';
$config['remote_debugger_password'] = 'admin';
