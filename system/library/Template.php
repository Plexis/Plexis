...
|
*/
    public function set_template_path($path = 'third_party/themes') 
    {
        // Set template path
        $path = trim($path, '/\\');
...
*/
    ...
    {
        $template_file = path($this->template['path'], $file);
...
*/
    protected function load_view()
    {
        ...
        {
            $file = path('third_party', 'modules', $this->config['controller'], 'views', $this->view_file .'.php');
        }
        else
        {
            ...
            $file = path($this->template['path'], 'views', $this->lang, $ext, $this->view_file .'.php');
        }
        ...
        {
            $file = path('system', 'views', $this->lang, $this->config['controller'], $this->view_file .'.php');
            if(file_exists($file))
            {
                return file_get_contents($file);
            }
...
|
*/
    public function load_template_xml()
    {
        // Build filepath
...
*/
    protected function view_js_string()
    {
        ...
        {
            $t_file = path($this->template['path'], 'js', $this->config['controller'], $this->view_file .'.js');
            $s_file = path('assets', 'js', $this->config['controller'], $this->view_file .'.js');
            ...
            {
                return '<script type="text/javascript" src="'. BASE_URL .'/assets/js/'. $this->config['controller'] .'/'.$this->view_file.'.js"></script>';
            }
        }
        return false; 
    }
...
*/
    protected function _build_header()
    {
        ...
        $this->append_metadata("") // Add whitespace
             ...
             ->append_metadata('<script type="text/javascript" src="'. BASE_URL .'/assets/js/jquery.js"></script>')
             ->append_metadata('<script type="text/javascript" src="'. BASE_URL .'/assets/js/jquery-ui.js"></script>')
             ->append_metadata('<script type="text/javascript" src="'. BASE_URL .'/assets/js/jquery.validate.js"></script>')
...
'. $string .'
             ...
             ->append_metadata('<script type="text/javascript" src="'. BASE_URL .'/assets/js/plexis.js"></script>'
        );
