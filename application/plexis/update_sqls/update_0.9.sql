DROP TABLE  `pcms_permissions`;
CREATE TABLE IF NOT EXISTS `pcms_permissions` (
...
--
-- Dumping data for table `pcms_permissions`
--
...
UPDATE `pcms_versions` SET `value`='0.9' WHERE (`key`='database');