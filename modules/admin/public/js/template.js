$(document).ready(function() {
	...
	/** Tooltips */
	$('a[rel=tooltip]').tipsy({fade: true, live: true, gravity: 'sw'});
	$('a[rel=tooltip-bottom]').tipsy({fade: true, live: true});
	$('a[rel=tooltip-right]').tipsy({fade: true, live: true, gravity: 'w'});
	$('a[rel=tooltip-top]').tipsy({fade: true, live: true, gravity: 's'});
	$('a[rel=tooltip-left]').tipsy({fade: true, live: true, gravity: 'e'});
	
	$('a[rel=tooltip-html]').tipsy({fade: true, live: true, html: true});
